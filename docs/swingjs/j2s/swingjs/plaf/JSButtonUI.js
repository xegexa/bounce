...
if (this.isAWT && this.isSimpleButton ) return $I$(8).getMinimumSizePeer$javax_swing_JComponent$O$Z(jc, this.button, true);
var ic;
...
;Clazz.setTVer('5.0.1-v7');//Created 2025-12-19 08:25:43 Java2ScriptVisitor version 5.0.1-v7 net.sf.j2s.core.jar version 5.0.1-v7
