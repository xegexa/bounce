...
(function(){/*m*/var C$=Clazz.newClass(P$, "JSFrameUI$lambda1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
), Clazz.new_(P$.JSFrameUI$lambda1.$init$,[this, {dim:dim}]))]);
}} else {
...
this.toFront$();
$I$(7).getEventQueue$().postEvent$java_awt_AWTEvent(Clazz.new_($I$(8,1).c$$java_awt_Component$I,[this.frame, 100]));
});
...
this.b$['swingjs.plaf.JSFrameUI'].frame.dispatchEvent$java_awt_AWTEvent(Clazz.new_($I$(10,1).c$$java_awt_Window$I,[this.b$['swingjs.plaf.JSFrameUI'].frame, 201]));
});
})()
), Clazz.new_(P$.JSFrameUI$1.$init$,[this, null]))],$I$(9,1).c$$I$java_awt_event_ActionListener);
...
this.bounds=Clazz.new_($I$(12,1).c$$I$I$I$I,[x, y, width, height]);
});
