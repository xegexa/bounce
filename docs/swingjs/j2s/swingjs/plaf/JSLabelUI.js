...
this.c=this.jc=jc;
this.updateDOMNode$();
return (this.isAWT ? C$.getMinimumSizePeer$javax_swing_JComponent$O$Z(jc, this.label, false) : this.label == null  ? C$.superclazz.prototype.getPreferredSize$javax_swing_JComponent.apply(this, [jc]) : $I$(4,"getPreferredButtonSize$javax_swing_AbstractButton$I",[(jc), (jc).getIconTextGap$()]));
});

Clazz.newMeth(C$, 'getMinimumSizePeer$javax_swing_JComponent$O$Z',  function (jc, label, preferredWidth) {
var f=jc.getFont$();
var s=null;
if (f == null ) return Clazz.new_($I$(5,1).c$$I$I,[14, 8]);
var fm=f.getFontMetrics$();
s=(label == null  ? (jc).getText$() : (label).getText$());
if (s == null ) s="";
var sz=f.getSize$();
var adj=(sz <= 40 ? C$.htAdj[sz] : 0);
return Clazz.new_([preferredWidth ? fm.stringWidth$S(s) + 14 : 4, fm.getHeight$() + adj],$I$(5,1).c$$I$I);
}, 1);
...
;Clazz.setTVer('5.0.1-v7');//Created 2025-12-19 08:25:45 Java2ScriptVisitor version 5.0.1-v7 net.sf.j2s.core.jar version 5.0.1-v7
