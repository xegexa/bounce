...
var fontInfo=C$.getCanvasFontScaled$java_awt_Font$D(font, 100);
if (context == null ) context=C$.getDefaultCanvasContext2d$();
var tm=null;
{
context.font = fontInfo;
tm = context.measureText(text);
tm = { "width":tm.width/100, "actualBoundingBoxAscent":tm.actualBoundingBoxAscent/100, "actualBoundingBoxDescent":tm.actualBoundingBoxDescent/100, "actualBoundingBoxLeft":tm.actualBoundingBoxLeft/100, "actualBoundingBoxRight":tm.actualBoundingBoxRight/100, "fontBoundingBoxAscent":tm.fontBoundingBoxAscent/100, "fontBoundingBoxDescent":tm.fontBoundingBoxDescent/100 }
}
return tm;
}, 1);
...
return C$.getCanvasFontScaled$java_awt_Font$D(font, 1);
}, 1);

Clazz.newMeth(C$, 'getCanvasFontScaled$java_awt_Font$D',  function (font, scale) {
var strStyle="";
if (font.isItalic$()) strStyle+="italic ";
if (font.isBold$()) strStyle+="bold ";
var family=C$.getCSSFontFamilyName$S(font.getFamily$());
font.getSize$();
return strStyle + (new Double(font.getSize2D$() * scale).toString()) + "px " + family ;
}, 1);
