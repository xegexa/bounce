...
var e;
if (id == 507) {
e=Clazz.new_($I$(3,1).c$$java_awt_Component$I$J$I$I$I$I$Z$I$I$I,[source, id, time, modifiers, x, y, count, popupTrigger, 0, 1, dy]);
} else {
e=Clazz.new_($I$(4,1).c$$java_awt_Component$I$J$I$I$I$I$Z$I,[source, id, time, modifiers, x, y, count, popupTrigger, button]);
