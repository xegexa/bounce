...
), Clazz.new_(P$.HTML5Video$2.$init$,[this, {label:label,whenReady:whenReady,jsvideo:jsvideo,maxWidth:maxWidth,dialog:dialog}])), ["canplaythrough"]);
...
Clazz.newMeth(C$, 'requestVideoFrameCallback',  function (jsvideo, callback) {
var f=null;
...
} else { callback.accept$O(metadata);
...
;Clazz.setTVer('5.0.1-v7');//Created 2025-12-19 08:25:41 Java2ScriptVisitor version 5.0.1-v7 net.sf.j2s.core.jar version 5.0.1-v7
