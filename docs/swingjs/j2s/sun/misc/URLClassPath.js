...
), Clazz.new_(P$.URLClassPath$1.$init$,[this, {name:name,check:check}]));
});
...
), Clazz.new_($I$(5,1),[this, {url:url,entry:entry,name:name}],P$.URLClassPath$JarLoader$2));
});
...
), Clazz.new_($I$(5,1),[this, {name:name,file:file,url:url}],P$.URLClassPath$FileLoader$1));
}} catch (e) {
if (Clazz.exceptionOf(e,"Exception")){
return null;
} else {
...
;Clazz.setTVer('5.0.1-v7');//Created 2025-12-19 08:25:25 Java2ScriptVisitor version 5.0.1-v7 net.sf.j2s.core.jar version 5.0.1-v7
