(function(){var P$=Clazz.newPackage("sun.font"),p$1={},p$2={},I$=[[0,['java.awt.geom.Rectangle2D','.Float'],'java.awt.geom.AffineTransform','java.awt.Rectangle',['java.awt.geom.Point2D','.Float'],['sun.font.StandardGlyphVector','.GlyphStrike'],'StringBuffer','swingjs.JSUtil','java.awt.RenderingHints','java.awt.font.FontRenderContext',['sun.font.StandardGlyphVector','.GlyphTransformInfo'],'java.awt.Shape',['sun.font.StandardGlyphVector','.ADL'],'java.awt.geom.GeneralPath','sun.font.DelegatingShape','java.awt.font.GlyphMetrics','swingjs.JSFontMetrics',['sun.font.StandardGlyphVector','.JSTextMetrics'],'swingjs.JSToolkit']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*c*/var C$=Clazz.newClass(P$, "StandardGlyphVector", function(){
Clazz.newInstance(this, arguments,0,C$);
}, 'java.awt.font.GlyphVector');
C$.$classes$=[['JSTextMetrics',10],['GlyphTransformInfo',24],['GlyphStrike',25],['ADL',8]];
...
C$.$fields$=[['I',['flags'],'S',['text'],'O',['jsMetrics','sun.font.StandardGlyphVector.JSTextMetrics[]','font','java.awt.Font','frc','java.awt.font.FontRenderContext','glyphs','int[]','+userGlyphs','positions','float[]','charIndices','int[]','gti','sun.font.StandardGlyphVector.GlyphTransformInfo','ftx','java.awt.geom.AffineTransform','+dtx','+invdtx','+frctx','font2D','sun.font.Font2D','fsref','sun.font.StandardGlyphVector.GlyphStrike','lbcacheRef','java.awt.Shape[]','+vbcacheRef']]]
...
Clazz.super_(C$, this);
this.text= String.instantialize(text);
...
Clazz.super_(C$, this);
this.text= String.instantialize(glyphs, 0, glyphs.length);
...
var trackPt=Clazz.new_($I$(4,1).c$$F$F,[track, 0]);
...
return (this.font.getFontMetrics$()).秘getStringBounds$S(this.text);
});
...
ix*=2;
return Clazz.new_($I$(4,1).c$$F$F,[this.positions[ix], this.positions[ix + 1]]);
});
...
if (ix < 0 || ix >= this.glyphs.length ) {
throw Clazz.new_(Clazz.load('IndexOutOfBoundsException').c$$S,["ix = " + ix]);
}return this.getGlyphOutline$I(ix).getBounds2D$();
});
...
result[n + 2]=w;
result[n + 3]=0;
var vb=this.getGlyphVisualBounds$I(i).getBounds2D$();
result[n + 4]=(vb.getMinX$());
result[n + 5]=(vb.getMinY$());
result[n + 6]=(vb.getWidth$());
result[n + 7]=(vb.getHeight$());
}
return result;
});
...
tx=Clazz.new_([tx.getScaleX$(), tx.getShearY$(), tx.getShearX$(), tx.getScaleY$(), 0, 0],$I$(2,1).c$$D$D$D$D$D$D);
}return tx;
}, 1);
...
p$1.resetDTX$java_awt_geom_AffineTransform.apply(this, [Clazz.new_($I$(2,1).c$$DA,[devTX])]);
}}, p$1);
...
var txs=Clazz.array($I$(2), [nGlyphs]);
...
p$1.getJavaScriptMetrics.apply(this, []);
...
this.ftx=$I$(2).getScaleInstance$D$D(s, s);
...
Clazz.newMeth(C$, 'getJavaScriptMetrics',  function () {
var n=this.text.length$();
this.jsMetrics=Clazz.array($I$(17), [n + 1]);
if (n == 1) {
this.jsMetrics[0]=this.jsMetrics[1]=Clazz.new_([this.text, $I$(18).getTextMetrics$swingjs_api_js_HTML5CanvasContext2D$java_awt_Font$S(null, this.font, this.text)],$I$(17,1).c$$S$sun_font_StandardGlyphVector_JSTextMetrics);
return;
}for (var i=n + 1; --i >= 0; ) {
var t=i == 0 ? this.text : this.text.substring$I$I(i - 1, i);
this.jsMetrics[i]=Clazz.new_([t, $I$(18).getTextMetrics$swingjs_api_js_HTML5CanvasContext2D$java_awt_Font$S(null, this.font, t)],$I$(17,1).c$$S$sun_font_StandardGlyphVector_JSTextMetrics);
}
}, p$1);
...
p$1.setFRCTX.apply(this, []);
p$1.initPositions.apply(this, []);
if (start == 0 && count == this.glyphs.length ) return this.jsMetrics[0].getActualBounds$F$F(x, y);
var r=this.jsMetrics[start + 1].getActualBounds$F$F(0, 0);
for (var i=1, p=start + 1; i < count; i++, p++) {
var r1=this.jsMetrics[p].getActualBounds$F$F(this.positions[p * 2], this.positions[p * 2 + 1]);
r.add$java_awt_geom_Rectangle2D(r1);
}
r.x+=x;
r.y+=y;
return r;
...
if (!r.isEmpty$()) {
if (result == null ) {
result=Clazz.new_($I$(3,1).c$$java_awt_Rectangle,[r]);
} else {
...
trackPt=Clazz.new_($I$(4,1).c$$F$F,[track, 0]);
}var pt=Clazz.new_($I$(4,1).c$$F$F,[0, 0]);
if (this.font.isTransformed$()) {
...
pt.x+=this.jsMetrics[i + 1].getLogicalWidth$();
if (trackPt != null ) {
pt.x+=trackPt.x;
pt.y+=trackPt.y;
...
gs=$I$(5).create$sun_font_StandardGlyphVector$java_awt_geom_AffineTransform$java_awt_geom_AffineTransform(this, this.dtx, null);
this.fsref=gs;
}return gs;
}, p$1);
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.StandardGlyphVector, "JSTextMetrics", function(){
...
C$.$fields$=[['F',['width','actualBoundingBoxLeft','actualBoundingBoxAscent','actualBoundingBoxRight','actualBoundingBoxDescent','fontBoundingBoxAscent','fontBoundingBoxDescent','offsetX','offsetY','logicalWidth'],'S',['text']]]

Clazz.newMeth(C$, 'c$$S$sun_font_StandardGlyphVector_JSTextMetrics',  function (text, tm) {
;C$.$init$.apply(this);
this.text=text;
this.width=tm.width;
...
this.logicalWidth=this.actualBoundingBoxRight - this.actualBoundingBoxLeft;
this.offsetX=-this.actualBoundingBoxLeft;
this.offsetY=this.actualBoundingBoxAscent + this.fontBoundingBoxDescent;
}, 1);

Clazz.newMeth(C$, 'getActualBounds$F$F',  function (x0, y0) {
var x=-this.actualBoundingBoxLeft;
var y=-this.actualBoundingBoxAscent;
var w=this.actualBoundingBoxRight - x;
var h=this.actualBoundingBoxDescent - y;
return Clazz.new_($I$(1,1).c$$F$F$F$F,[x + x0, y + y0, w, h]);
});

Clazz.newMeth(C$, 'getLogicalWidth$',  function () {
...
return Clazz.new_($I$(2,1).c$$D$D$D$D$D$D,[this.transforms[x + 0], this.transforms[x + 1], this.transforms[x + 2], this.transforms[x + 3], this.transforms[x + 4], this.transforms[x + 5]]);
});
...
strikes=Clazz.array($I$(5), [this.transformCount$() + 1]);
...
var gtx=Clazz.new_($I$(2,1).c$$D$D$D$D$D$D,[this.transforms[ix], this.transforms[ix + 1], this.transforms[ix + 2], this.transforms[ix + 3], this.transforms[ix + 4], this.transforms[ix + 5]]);
strike=$I$(5).create$sun_font_StandardGlyphVector$java_awt_geom_AffineTransform$java_awt_geom_AffineTransform(this.sgv, this.sgv.dtx, gtx);
...
gp.transform$java_awt_geom_AffineTransform(this.sgv.invdtx);
gp.transform$java_awt_geom_AffineTransform($I$(2).getTranslateInstance$D$D(x + this.dx, y + this.dy));
...
;Clazz.setTVer('5.0.1-v7');//Created 2025-12-19 08:25:23 Java2ScriptVisitor version 5.0.1-v7 net.sf.j2s.core.jar version 5.0.1-v7
