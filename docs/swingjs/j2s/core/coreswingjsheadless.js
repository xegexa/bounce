...
}data=(fileCache == null  ? null : fileCache.get$O(javapath));
if (data == null  && fileCache != null  ) {
data=fileCache.get$O(fname);
}if (data == null ) {
data=$I$(9).J2S.getFileData(fname, null, true, true);
}{
...
var bytes = (data.__BYTESIZE == 1 ? data : data.data ? data : J2S._strToBytes(data));
...
ms[i]=Clazz_new_([this, name, null, Clazz_getClass($I$(15)), null, p$1.getMods$Z.apply(this, [isNative])],$I$(1,1).c$$Class$S$ClassA$Class$ClassA$I);
}
return ms;
...
var m=Clazz_new_([this, attr, Class.UNKNOWN_PARAMETERS, Clazz_getClass($I$(15)), Class.NO_PARAMETERS, p$1.getMods$Z.apply(this, [isNative])],$I$(1,1).c$$Class$S$ClassA$Class$ClassA$I);
...
m=Clazz_new_([this, attr, Class.UNKNOWN_PARAMETERS, Clazz_getClass($I$(15)), Class.NO_PARAMETERS, p$1.getMods$Z.apply(this, [isNative])],$I$(1,1).c$$Class$S$ClassA$Class$ClassA$I);
...
Clazz_newMeth(C$, 'getMods$Z',  function (isNative) {
var mods=1;
...
/*lambda_C*/
Clazz_newMeth(C$, 'get$',  function () { return Clazz_new_($I$(21,1),[this,null])});
})()
...
;Clazz_setTVer('5.0.1-v7');//Created 2025-04-20 17:00:22 Java2ScriptVisitor version 5.0.1-v7 net.sf.j2s.core.jar version 5.0.1-v7
...
;Clazz_setTVer('5.0.1-v7');//Created 2025-04-02 04:54:12 Java2ScriptVisitor version 5.0.1-v7 net.sf.j2s.core.jar version 5.0.1-v7
...
;Clazz_setTVer('5.0.1-v7');//Created 2025-04-02 04:54:13 Java2ScriptVisitor version 5.0.1-v7 net.sf.j2s.core.jar version 5.0.1-v7
...
;Clazz_setTVer('5.0.1-v7');//Created 2025-04-02 04:54:50 Java2ScriptVisitor version 5.0.1-v7 net.sf.j2s.core.jar version 5.0.1-v7
...
;Clazz_setTVer('5.0.1-v7');//Created 2025-04-02 04:57:00 Java2ScriptVisitor version 5.0.1-v7 net.sf.j2s.core.jar version 5.0.1-v7
