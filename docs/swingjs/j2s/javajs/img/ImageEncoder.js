...
C$.$fields$=[['Z',['logging','doClose'],'I',['width','height','quality','dpi'],'S',['date'],'O',['out','javajs.util.OC','pixels','int[]']]]
...
this.generate$();
this.close$();
params.put$O$O("qualityActual", Integer.valueOf$I(this.quality));
if (this.dpi > 0) params.put$O$O("DPI", Integer.valueOf$I(this.dpi));
return this.doClose;
});
