(function(){var P$=Clazz.newPackage("javajs.util"),p$1={},I$=[[0,'java.util.Hashtable','javajs.util.SB','javajs.util.Lst']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['Z',['wasUnquoted','asObject','debugging','isLoop','haveData','isHeader','skipToken'],'C',['cterm'],'I',['ich','cch','ichPeeked','columnCount','nTypesRemaining'],'S',['line','str'],'O',['reader','javajs.api.GenericLineReader','br','java.io.BufferedReader','strPeeked','java.lang.Object','columnNames','String[]','columnData','Object[]','fileHeader','javajs.util.SB']]
,['S',['nullString'],'O',['htFields','java.util.Map']]]
...
return this.getAllCifDataType$SA(null);
});
...
for (var i=0; i < types.length; i++) {
if (key.startsWith$S(types[i])) {
if (key.equals$O(types[i])) --this.nTypesRemaining;
return true;
}}
return false;
}, p$1);
...
if ((str.charCodeAt$I(0)) != 0 ) ret.append$S(str).append$S(" ");
...
return (key.charAt$I(1) == "m" && key.startsWith$S("_magnetic")  ? key.substring$I(9) : key.charAt$I(1) == "j" && key.startsWith$S("_jana")  ? key.substring$I(5) : key).replace$C$C(".", "_").toLowerCase$();
});
...
if (this.ich == ichStart + 1) if (C$.nullString != null  && (this.str.charAt$I(ichStart) == "." || this.str.charAt$I(ichStart) == "?" ) ) return C$.nullString;
...
if (types == null  || p$1.checkKey$SA$S.apply(this, [types, key]) ) {
...
var cdata=data.get$O(keyWords.get$I(i));
if (cdata != null ) cdata.addLast$O(this.columnData[i]);
}
}
}this.isLoop=false;
}, p$1);
...
;Clazz.setTVer('5.0.1-v7');//Created 2025-12-19 08:24:44 Java2ScriptVisitor version 5.0.1-v7 net.sf.j2s.core.jar version 5.0.1-v7
