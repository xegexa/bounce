...
Clazz.newMeth(C$, 'doAjax$Z$Z$java_util_function_Function',  function (isBinary, isScript, whenDone) {
...
if (whenDone != null  || isScript ) return null;
...
whenDone.apply$O(is);
return;
}p$1.doAjax$Z$Z$java_util_function_Function.apply(this, [true, false, ((P$.AjaxURLConnection$2||
...
return is;
}var isScript=this.ajax && (this.ajax.dataType == "script")||false;
var result=p$1.doAjax$Z$Z$java_util_function_Function.apply(this, [this.ajax == null , isScript, null]);
if (isScript) return $I$(7,"getBIS$BA",[Clazz.array(Byte.TYPE, [0])]);
is=C$.attachStreamData$java_net_URL$O(this.url, result);
...
return p$1.doAjax$Z$Z$java_util_function_Function.apply(this, [false, false, null]);
});
