...
Clazz.newMeth(C$, 'makeSink$',  function () {
return Clazz.new_($I$(3,1),[this, {accumulator:this.$finals$.accumulator,supplier:this.$finals$.supplier,combiner:this.$finals$.combiner}],P$.ReduceOps$3ReducingSink);
});
...
), Clazz.new_([this, {collector:collector,accumulator:accumulator,supplier:supplier,combiner:combiner}, $I$(5).REFERENCE],$I$(4,1).c$$java_util_stream_StreamShape,P$.ReduceOps$3));
}, 1);
...
Clazz.newMeth(C$, 'makeSink$',  function () {
return Clazz.new_($I$(3,1),[this, {supplier:this.$finals$.supplier,combiner:this.$finals$.combiner,accumulator:this.$finals$.accumulator}],P$.ReduceOps$7ReducingSink);
});
})()
), Clazz.new_([this, {supplier:supplier,combiner:combiner,accumulator:accumulator}, $I$(5).INT_VALUE],$I$(4,1).c$$java_util_stream_StreamShape,P$.ReduceOps$7));
}, 1);
...
Clazz.newMeth(C$, 'makeSink$',  function () {
return Clazz.new_($I$(3,1),[this, {combiner:this.$finals$.combiner,supplier:this.$finals$.supplier,accumulator:this.$finals$.accumulator}],P$.ReduceOps$10ReducingSink);
});
})()
), Clazz.new_([this, {combiner:combiner,supplier:supplier,accumulator:accumulator}, $I$(5).LONG_VALUE],$I$(4,1).c$$java_util_stream_StreamShape,P$.ReduceOps$10));
}, 1);
...
;Clazz.setTVer('5.0.1-v7');//Created 2025-12-19 08:24:40 Java2ScriptVisitor version 5.0.1-v7 net.sf.j2s.core.jar version 5.0.1-v7
