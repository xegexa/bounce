...
/*lambda_E*/
Clazz.newMeth(C$, 'apply$O$O',  function (u, v) /*block*/{
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$java_util_Collection$java_util_Collection','apply$O$O'],  function (r1, r2) /*block*/{
...
/*lambda_C*/
Clazz.newMeth(C$, 'get$',  function () { return Clazz.new_($I$(11,1),[this,null])});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$java_util_List$java_util_List','apply$O$O'],  function (left, right) /*block*/{
...
/*lambda_C*/
Clazz.newMeth(C$, 'get$',  function () { return Clazz.new_($I$(13,1),[this,null])});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$java_util_Set$java_util_Set','apply$O$O'],  function (left, right) /*block*/{
left.addAll$java_util_Collection.apply(left, [right]);
return left;
});
})()
...
/*lambda_C*/
Clazz.newMeth(C$, 'get$',  function () { return Clazz.new_($I$(15,1),[this,null])});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$StringBuilder$StringBuilder','apply$O$O'],  function (r1, r2) /*block*/{
...
), Clazz.new_(P$.Collectors$lambda15.$init$,[this, {prefix:prefix,suffix:suffix,delimiter:delimiter}])), (function($$){((
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$java_util_Map$java_util_Map','apply$O$O'],  function (m1, m2) /*block*/{
...
/*lambda_E*/
Clazz.newMeth(C$, 'apply$O',  function (e) { return (Long.valueOf$J(1));});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['accept$IA$O','accept$O$O'],  function (a, t) /*block*/{
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$IA$IA','apply$O$O'],  function (a, b) /*block*/{
a[0]+=b[0];
return a;
});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$IA','apply$O'],  function (a) { return (Integer.valueOf$I(a[0]));});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['accept$JA$O','accept$O$O'],  function (a, t) /*block*/{
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$JA$JA','apply$O$O'],  function (a, b) /*block*/{
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$JA','apply$O'],  function (a) { return (Long.valueOf$J(a[0]));});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['accept$DA$O','accept$O$O'],  function (a, t) /*block*/{
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$DA$DA','apply$O$O'],  function (a, b) /*block*/{
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$DA','apply$O'],  function (a) { return (Double.valueOf$D($I$(1).computeFinalSum$DA(a)));});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$JA','apply$O'],  function (a) { return (Double.valueOf$D((Long.$eq(a[1],0 )) ? 0.0 : Long.$dval(a[0]) / a[1]));});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$DA','apply$O'],  function (a) { return (Double.valueOf$D((a[2] == 0 ) ? 0.0 : ($I$(1).computeFinalSum$DA(a) / a[2])));});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['accept$OA$O','accept$O$O'],  function (a, t) /*block*/{
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$OA$OA','apply$O$O'],  function (a, b) /*block*/{
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$java_util_stream_Collectors$1OptionalBox$java_util_stream_Collectors$1OptionalBox','apply$O$O'],  function (a, b) /*block*/{
...
/*lambda_C*/
Clazz.newMeth(C$, 'get$',  function () { return Clazz.new_($I$(20,1),[this,null])});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['accept$java_util_Map$O','accept$O$O'],  function (m, t) /*block*/{
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$java_util_Map','apply$O'],  function (intermediate) /*block*/{
...
/*lambda_C*/
Clazz.newMeth(C$, 'get$',  function () { return Clazz.new_($I$(22,1),[this,null])});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['accept$java_util_concurrent_ConcurrentMap$O','accept$O$O'],  function (m, t) /*block*/{
var key=$I$(21,"requireNonNull$O$S",[this.$finals$.classifier.apply$O.apply(this.$finals$.classifier, [t]), "element cannot be mapped to a null key"]);
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$java_util_concurrent_ConcurrentMap','apply$O'],  function (intermediate) /*block*/{
...
), Clazz.new_(P$.Collectors$lambda75.$init$,[this, {mergeFunction:mergeFunction,valueMapper:valueMapper,keyMapper:keyMapper}]));
...
/*lambda_C*/
Clazz.newMeth(C$, 'get$',  function () { return Clazz.new_($I$(24,1),[this,null])});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$java_util_IntSummaryStatistics$java_util_IntSummaryStatistics','apply$O$O'],  function (l, r) /*block*/{
...
/*lambda_C*/
Clazz.newMeth(C$, 'get$',  function () { return Clazz.new_($I$(25,1),[this,null])});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$java_util_LongSummaryStatistics$java_util_LongSummaryStatistics','apply$O$O'],  function (l, r) /*block*/{
...
/*lambda_C*/
Clazz.newMeth(C$, 'get$',  function () { return Clazz.new_($I$(26,1),[this,null])});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$java_util_DoubleSummaryStatistics$java_util_DoubleSummaryStatistics','apply$O$O'],  function (l, r) /*block*/{
...
;Clazz.setTVer('5.0.1-v7');//Created 2025-12-19 08:24:39 Java2ScriptVisitor version 5.0.1-v7 net.sf.j2s.core.jar version 5.0.1-v7
