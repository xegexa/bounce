...
/*lambda_E*/
Clazz.newMeth(C$, ['accept$JA$J','accept$O$O'],  function (ll, i) /*block*/{
...
/*lambda_E*/
Clazz.newMeth(C$, ['accept$JA$JA','accept$O$O'],  function (ll, rr) /*block*/{
...
/*lambda_C*/
Clazz.newMeth(C$, 'get$',  function () { return Clazz.new_($I$(18,1),[this,null])});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, 'apply$O$O',  function (left, right) /*block*/{
