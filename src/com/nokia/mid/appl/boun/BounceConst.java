...
public class BounceConst {
  ...
  /** Swing / CheerpJ client area width; 128×128 game buffer is scaled to this size. */
  public static final int WINDOW_WIDTH = 400;

  public static final int WINDOW_HEIGHT = 400;

  /** JMenuBar height; frame height is {@code WINDOW_HEIGHT + FRAME_MENU_BAR_HEIGHT}. */
  public static final int FRAME_MENU_BAR_HEIGHT = 22;
  ...
  public static final String SPLASH_NAME_NOKIA = "res/icons/nokiagames.png";
  
  public static final String SPLASH_NAME_BOUNCE = "res/icons/bouncesplash.png";
  
  public static final String SOUND_HOOP_NAME = "res/sounds/up.ott";
  
  public static final String SOUND_PICKUP_NAME = "res/sounds/pickup.ott";
  
  public static final String SOUND_POP_NAME = "res/sounds/pop.ott";
  
  public static final int SPLASH_TIMER_DELAY = 30;

  /** Game loop timer period in ms (one simulation + paint per tick). */
  public static final int GAME_TICK_MS = 30;
}
